...
def make_target(target_dir,image_dir,input_height,input_width,app_dir,model):
...
def main():
    ...
    make_target(args.target_dir, args.image_dir, args.input_height, args.input_width, args.app_dir, args.model)

...
This version of calculateMetrics.py compares the output of the serial 
compressions to the original, uncompressed images.
"""
import os
import cv2
import numpy as np
...
# the location of the output from CNNJPEG-encoder.py.
origDir = "./inputs_val/"
compDir = "./serial_val/"
...
for file in os.listdir(origDir):
    ...
    comp = cv2.imread( compDir+str(count)+".jpg" )
    ...
    compSize = os.path.getsize(compDir+str(count)+".jpg")
